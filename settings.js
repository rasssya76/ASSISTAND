...
global.email = 'botlord97@gmail.com' 
global.region = 'indonesia'
//—————「 Set Nama Own & Bot 」—————//
global.ownername = 'R-BOT' //ubah jadi nama mu, note tanda ' gausah di hapus!
global.botname = 'R-BOT' //ubah jadi nama bot mu, note tanda ' gausah di hapus!
...
global.sessionName = './sessionye/rm76'
global.prefa = ['','!','.',',','🐤','🗿']
global.sp = '⭔'
global.mess = {
...
global.log0 = fs.readFileSync("./baseikal/image/rm76.jpg")
global.menuimg = 'https://k.top4top.io/p_2388xws321.jpg'
global.ggikal = fs.readFileSync("./baseikal/video/rm76.mp4")
//=================================================//
