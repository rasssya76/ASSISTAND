...
//—————「 Set Nama Own & Bot 」—————//
global.ownername = 'Rama' //ubah jadi nama mu, note tanda ' gausah di hapus!
global.botname = 'Rama' //ubah jadi nama bot mu, note tanda ' gausah di hapus!
global.footer = 'Rama' //ubah jadi nama mu, note tanda ' gausah di hapus!
//=================================================//
// Other
...
//=================================================//
global.thumb = fs.readFileSync("./database/image/hw.jpg")
global.visoka = fs.readFileSync("./database/video/hikal.gif")
global.log0 = fs.readFileSync("./database/image/haikal.jpg")
global.menuimg = 'https://k.top4top.io/p_2388xws321.jpg'
global.ggikal = fs.readFileSync("./database/video/haikal.mp4")
//=================================================//
